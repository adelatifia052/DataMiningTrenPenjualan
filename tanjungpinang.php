...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <center><h1 class="mt-4">PUSAT TANJUNG PINANG</h1></center>
            ...
            <?php
            // Baca file CSV
            $filePath = __DIR__ . '/data/pusatpinang.csv'; // Sesuaikan path
            $data = [];
            ...
            $PINANG = array_column($data, 'PINANG');
            ?>

            <script>
            // Data PHP ke JavaScript
            const labels = <?php echo json_encode($BULAN); ?>;
            const pinang = <?php echo json_encode($PINANG); ?>;
            ...
            const colorArray = Array.from({length: pinang.length}, (v, i) => colors[i % colors.length]);
            ...
            new Chart(ctxBar, {
                ...
                data: {
                    ...
                    datasets: [
                        {
                            label: 'Penjualan Pusat Pinang Paleo Tanjungpinang',
                            data: pinang,
