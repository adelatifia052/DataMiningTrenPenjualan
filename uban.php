...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <center><h1 class="mt-4">CABANG TANJUNG UBAN</h1></center>
            ...
            <?php
            // Baca file CSV
            $filePath = __DIR__ . '/data/cabanguban.csv'; // Sesuaikan path
            $data = [];
            ...
            const colorArray = Array.from({length: uban.length}, (v, i) => colors[i % colors.length]);
